...
<body>
    ...
    <h4>GET 요청</h4>
    <a href="./proc/result1.jsp?uid=a101">요청1</a><br/>
    <a href="./proc/result1.jsp?uid=a102&name=홍길동">요청2</a><br/>
    <a href="./proc/result1.jsp?uid=a103&name=김유신&age=23">요청3</a><br/>
    ...
    <p>
        ...
        헤더정보 #2: <%= request.getHeader("referer") %><br/><!-- 현재 머무르고 있는 페이지  -->
